...
- My lens: from a skills perspective, what are data scientists 
:::
...
library(duckdb)
#SELECT * FROM 'svi_county_2022.csv';
...
:::
![GitHub](images/github.png "Title: An elephant"){fig-alt="github logo" fig-align="left"}
